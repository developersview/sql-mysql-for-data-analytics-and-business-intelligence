...
how many have been signed for a value above the average? Store the output in a column named no_m_salaries_above_avg. 
In a second column named total_no_of_salary_contracts, 
