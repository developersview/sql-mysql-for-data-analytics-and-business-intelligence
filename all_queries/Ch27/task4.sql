...
*/
USE employees_mod;
DROP PROCEDURE IF EXISTS sp_filter_salary;

DELIMITER $$
CREATE PROCEDURE sp_filter_salary (IN p_min_salary FLOAT, IN p_max_salary FLOAT)
BEGIN
SELECT 
...
CALL sp_filter_salary(50000, 90000);sp_filter_salary;
